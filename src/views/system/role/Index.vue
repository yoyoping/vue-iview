  ...
  <div>
    ...
    >
      ...
      >
        ...
        <FormItem label="标识" prop="identification">
          <Input
            v-model="formValidate.identification"
            placeholder="请输入标识"
          ></Input>
        </FormItem>
    ...
    >
      <p slot="footer">
        ...
        <Button @click="addRoleModal = false" style="margin-left: 8px"
          >取消</Button
        >
      </p>
      <Form
  ...
  data() {
    return {
      ...
      ruleValidate: {
        ...
        auth: [{ required: true, message: "请输入权限", trigger: "change" }]
      },
      columns7: [
        {
          type: "selection",
