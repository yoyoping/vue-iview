<template>
  <!-- <el-col :span="19" :offset="1"> -->
    <div class="_city">
      <Row :gutter="20">
        <Col span="8">
          <Select v-model="province" placeholder="请选择" @on-change="province_">
            <Option
        ...
        <Col span="8">
          <Select v-model="city" placeholder="请选择" @on-change="city_" :disabled="citydisabled">
            <Option
        ...
        <Col span="8">
          <Select v-model="area" placeholder="请选择" :disabled="areadisabled" @on-change="area_" v-if="!isArea && isArea2">
            <Option
